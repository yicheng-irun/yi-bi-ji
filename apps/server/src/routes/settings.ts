...
settingsRoutes.put('/', async (c) => {
  ...
  const keys: (keyof Settings)[] = [
    ...
    'voiceProvider', 'voiceAsrUrl', 'voiceAsrModel', 'voiceTtsUrl', 'voiceTtsModel', 'voiceTtsVoice',
    'voiceLang', 'voiceAutoSpeak', 'voiceAutoSend', 'voiceProfiles', 'voiceActiveProfile',
  ]
